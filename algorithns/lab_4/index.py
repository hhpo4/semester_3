...
def read_data_from_file(filename):
    ...
    for line in lines:
        ...
        data["interpolation_search"].append(float(values[3]))
...
plt.plot(sizes, experimental_data["binary_search"], label="fib Search", marker='s', linestyle='-')
plt.plot(sizes, experimental_data["interpolation_search"], label="Interpolation Search", marker='^', linestyle='-.')
